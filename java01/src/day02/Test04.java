...
/*
 	생성자 
 		: 클래스가 객체가 될 때 클래스의 맴버가 가져야될 기본 값이 있을 것이다.
 			이 때 그 맴버들의 기본값을 셋팅해주는 혁활을 하는 것이 생성자 함수...
 		...
 		***
 		*생성자 함수를 하나도 정의하지 않으면 자바 가상머신이 자동으로 기본 생성자 함수를 만들어서 호출해준다.
 		...
 		따라서 
 		생성자 함수를 정의를 할꺼면
 		기본 생성자 함수를 내용이 없더라도 정의 해두는 것이 좋다.
 */
