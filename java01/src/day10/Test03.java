package day10;
/*
 	Nemo 클래스를 5개 관리한 배열을 만들고
 	가로 세로는 1 ~ 29 까지 랜덤하게 배열을 완성하자.
...
public class Test03 {
	...
	public void setNemo() {
		...
		for(int i =0; i<nemo.length; i++) {
			...
			// Nemo 인스턴스는 만들어 뒀는데 아직 가로, 세로, 넓이는 입력되지 않았다.
			//따라서 현재 가로 세로 넓이는 0으로 셋팅이 되어있다.
			//이제 가로 세로 넓이를 셋팅을 해주자. 우리는 그것의 기능을 만들어 뒀으므로 그 기능을 사용해보자.
			//먼저 숫자 두개를 만든다.
	...
	public static void main(String[] args) {
		...
		//출력해준다. 멤버 변수의 내용을  출력해주는 함수를 만들어 뒀다. 그것을 호출한다.
